...
//			DirtyHack for JMX-over-HTTP
			if (port == JMX_OVER_HTTP_PORT) {
				urlString = System.getProperty("jmx:service.url","service:jmx:http-remoting-jmx://" + conn + ":" + port);
			} else {
                urlString = System.getProperty("jmx:service.url","service:jmx:rmi:///jndi/rmi://[" + conn + "]:" + port + "/jmxrmi");
            }
...
//          End of DirtyHack
			...
			logger.debug("Auth-data: user: " + username+" passwd: "+password);
